...
* \author
* \copyright Worldline TR (R&D).
**/

#ifndef __GMPSmartDLL_H__
#define __GMPSmartDLL_H__

#define GMP_DLL_VERSION_STR						"v16r38"
...
enum
{
	...
	GMP_EXT_DEVICE_FUNC_NTP_CHECK					= 0x000000027,
	GMP_EXT_DEVICE_FUNC_PAPER_EJECT					= 0x000000028,
	GMP_EXT_DEVICE_FUNC_BIT_Z_RAPOR_GONDER_P16		= 0x000000029,
...
//#define GMP3_OPTION_DONT_ALLOW_NEW_ITEM							(1 << 7)	/**< ECR will not allow new item entry during transaction */
//#define GMP3_OPTION_DONT_ALLOW_VOID_ITEM							(1 << 8)	/**< ECR will not allow to void an item during transaction */
...
#define GMP3_OPTION_SAVE_LAST_TRANS									(1 << 10)	/**< ECR will not allow to print merchant slip if customer signature is not required */
...
#define GMP3_PS_EJECT	                       (1 << 24)
#define GMP3_PS_CUT		                       (1 << 25)
#define GMP3_PS_QR_MULT8		               GMP3_PS_48
#define GMP3_PS_QR_MULT4		               GMP3_PS_32
#define GMP3_PS_QR_MULT2		               GMP3_PS_12
#define GMP3_PS_QR_MULT1		               GMP3_PS_24
#define GMP3_PS_QR_CENTER		               GMP3_PS_CENTER
#define GMP3_PS_QR_RIGHT		               GMP3_PS_RIGHT


#define SUPPORT_COMPRESSION_V1					 (1 << 0)		/**< support of compression V1 type */
#define SUPPORT_GMP3_NOT_ENCRYPTION				 (1 << 1)		/**< support gmp3 not encrytption */
...
#define GMP3_CARD_SUPPORT_TYPE_ALL							0x00
#define GMP3_CARD_SUPPORT_TYPE_CHIP							0x01
#define GMP3_CARD_SUPPORT_TYPE_SWIPE						0x02
#define GMP3_CARD_SUPPORT_TYPE_MANUAL						0x04
#define GMP3_CARD_SUPPORT_TYPE_CLESS						0x08
#define GMP3_CARD_SUPPORT_TYPE_QR_POS_PRESENT				0x10
#define GMP3_CARD_SUPPORT_TYPE_EPARA						0x20
#define GMP3_CARD_SUPPORT_TYPE_YEMEK_CEKI					0x40

#define APP_OPT2_SUPPORT_GET_MERCHANT_SLIP						0x00000200	/**< The Application supports Not print Merchans slip and Send Merchants Slip. */
...
typedef enum
{
	...
	GMP3_SUBCOMMAND_FISCALPRINTER_SET_E_TICKET_INFO					= 0x002D,
	GMP3_SUBCOMMAND_FISCALPRINTER_SET_E_IRSALIYE_INFO				= 0x002E,
	GMP3_SUBCOMMAND_FISCALPRINTER_SET_SMM_BILGI						= 0x002F,
	GMP3_SUBCOMMAND_FISCALPRINTER_GET_CURRENNT_HANDLE				= 0x0030,
...
typedef enum
{
	...
	GMP_TAG_HASH_INFO_GRUBU										=	0xDF51,
...
typedef enum _GMP_TAG_LIST_EXT_DEVICE
{
	...
	GMP_EXT_DEVICE_IZINLI_KDV_LISTESI							= 0xDFED3D,		/**< 0xDFED3D,  */
	GMP_EXT_DEVICE_NACE_KOD_LISTESI								= 0xDFED3E,		/**< 0xDFED3E,  */
	GMP_EXT_DEVICE_LAST_TRANS_INFO								= 0xDFED3F,		/**< 0xDFED3F,  */
	...
	GMP_EXT_DEVICE_ODEME_TIP_YENI								= 0xDFED5F,		/**< 0xDFED5F, (uint64) Type of the payment, one of EPaymentTypes */
	...
	GMP_EXT_DEVICE_ODEME_TIP_AMOUNT								= 0xDFED88,		/**< 0xDFED88, (bcd[6]) Payment tip amount in bcd format with 2 precisition. Exp; it is 0x000000230050 for the amount of 2300,50 */
	GMP_EXT_DEVICE_ODEME_TIP_ITEM_INDEX							= 0xDFED89,		/**< 0xDFED89, (bcd[2]) Payment tip item index in bcd format */
	...
	GMP_EXT_DEVICE_ALLOWED_INPUT_TYPE							= 0xDFED8D,		/**< 0xDFED8D, External Device Trans SubType */
	GMP_EXT_DEVICE_ALLOWED_PAYMENT_TYPE_OLD						= 0xDFED8E,		/**< 0xDFED8E, External Device allowed Old Payment Type*/
	GMP_EXT_DEVICE_ALLOWED_PAYMENT_TYPE							= 0xDFED8F,		/**< 0xDFED8F, External Device allowed Payment Type*/
	...
	GMP_EXT_GIDER_PUSUSULASI_AMOUNT												= 0xDFEE10,		/**< 0xDFEE10,  */
	GMP_EXT_GIDER_PUSUSULASI_ADET												= 0xDFEE11,		/**< 0xDFEE11,  */
	GMP_EXT_GIDER_PUSUSULASI_NEVI												= 0xDFEE12,		/**< 0xDFEE12,  */
	...
	GMP_EXT_DIGER_BELGE_ETTN									= 0xDFEE2D,		/**< 0xDFEE2D,  */
	...
	GMP_EXT_DEVICE_COMBINED_PAYMENT_TABLE						= 0xDFF000,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_TYPE						= 0xDFF001,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBTYPE						= 0xDFF002,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_COUNT			= 0xDFF003,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_TOTAL_AMOUNT				= 0xDFF004,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_TRANS_CODE					= 0xDFF005,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_RECORD			= 0xDFF006,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_TYPE				= 0xDFF007,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_CURRENCY_CODE	= 0xDFF008,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_AMOUNT			= 0xDFF009,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_ACQUIRER_ID		= 0xDFF00A,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_ISSUER_ID		= 0xDFF00B,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_AUTHORIZATION_CODE = 0xDFF00C,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_INSTALMENT_COUNT = 0xDFF00D,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_INSTALMENT_DESC	= 0xDFF00E,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_DESCRIPTION		= 0xDFF00F,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_VAT_COUNT		= 0xDFF010,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_VAT_RECORD		= 0xDFF011,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_VAT_RATE			= 0xDFF012,
	GMP_EXT_DEVICE_COMBINED_PAYMENT_SUBPAYMENT_VAT_PAY_AMOUNT	= 0xDFF013,

	GMP_EXT_DEVICE_BANKA_SUPPORTED_PAYMENT						= 0xDFF01A,
	GMP_EXT_DEVICE_BANKA_FLAG1									= 0xDFF01B,
	GMP_EXT_DEVICE_BANKA_FLAG2									= 0xDFF01C,
	GMP_EXT_DEVICE_BANKA_VERSION								= 0xDFF01D,

	GMP_EXT_DEVICE_E_TICKET_INFO_BELGE_NO						= 0xDFF020,
	GMP_EXT_DEVICE_E_TICKET_INFO_ETTN							= 0xDFF021,
	GMP_EXT_DEVICE_E_TICKET_INFO_FILM_ADI						= 0xDFF022,
	GMP_EXT_DEVICE_E_TICKET_INFO_TIP							= 0xDFF023,
	GMP_EXT_DEVICE_E_TICKET_INFO_TARIH_SAAT						= 0xDFF024,
	GMP_EXT_DEVICE_E_TICKET_INFO_BELEDIYE						= 0xDFF025,
	GMP_EXT_DEVICE_E_TICKET_INFO_SINEMA_ADI						= 0xDFF026,
	GMP_EXT_DEVICE_E_TICKET_INFO_SALON_ADI						= 0xDFF027,
	GMP_EXT_DEVICE_E_TICKET_INFO_KOLTUK_BILGI					= 0xDFF028,

	GMP_EXT_DEVICE_E_IRSALIYE_NO								= 0xDFF030,
	GMP_EXT_DEVICE_E_IRSALIYE_ETTN								= 0xDFF031,
	GMP_EXT_DEVICE_E_IRSALIYE_CUSTOMER_TCKN						= 0xDFF032,
	GMP_EXT_DEVICE_E_IRSALIYE_CUSTOMER_NAME						= 0xDFF033,
	GMP_EXT_DEVICE_E_IRSALIYE_CUSTOMER_ADRESS					= 0xDFF034,
	GMP_EXT_DEVICE_E_IRSALIYE_DRIVER_TCKN						= 0xDFF035,
	GMP_EXT_DEVICE_E_IRSALIYE_DRIVER_NAME						= 0xDFF036,
	GMP_EXT_DEVICE_E_IRSALIYE_VEHICLE_PLATE						= 0xDFF037,
	GMP_EXT_DEVICE_E_IRSALIYE_TRANSFER_DATE						= 0xDFF038,

	GMP_EXT_DEVICE_24H_RESET_START_TIME							= 0xDFF040,
	GMP_EXT_DEVICE_24H_RESET_END_TIME							= 0xDFF041,
	GMP_EXT_DEVICE_24H_RESET_BEFORE_MANAGER						= 0xDFF042,
	...
	GMP_TAG_SURUCU_VERSIYON_YENI								= 0xDFEF14,		/**< 0xDFEF14, (uint8[15]) External Device software driver version */
	GMP_TAG_SUPPORTED_CERT_KEY_TYPE								= 0xDFEF15,		/**< 0xDFEF14, (uint8[15]) External Device software driver version */
	...
	GMP_EXT_DEVICE_HEADER_COUNTRY_CODE							= 0XDFEF57,		/**< 0XDFEF57,  */
	GMP_EXT_DEVICE_HEADER_SUBE_KODU								= 0XDFEF58,		/**< 0XDFEF58,  */
	...
	GMP_EXT_DEVICE_HASH_FIRST_DATE								= 0xDFEFC5,
	GMP_EXT_DEVICE_HASH_LAST_DATE								= 0xDFEFC6,
	GMP_EXT_DEVICE_HASH_EXPIRE_DATE								= 0xDFEFC7,

	GMP_EXT_DEVICE_USER_MESSAGE_EX								= 0xDFEFD0,		/**< 0xDFEFD0,  */
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_TABLE							= 0xDFEFD1,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_RECORD_COUNT					= 0xDFEFD2,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_RECORD						= 0xDFEFD3,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_VAT_PERCENTAGE				= 0xDFEFD4,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_SALE_AMOUNT					= 0xDFEFD5,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_VAT_AMOUNT					= 0xDFEFD6,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_OUT_OF_TAX_SALE_AMOUNT		= 0xDFEFD7,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_OUT_OF_TAX_VAT_AMOUNT			= 0xDFEFD8,
	GMP_EXT_DEVICE_FIS_ITEM_OUT_OF_TAX_VAT_AMOUNT				= 0xDFEFD9,
	GMP_EXT_DEVICE_FIS_TICKET_TOTAL_YEMEKCEKI_PAID_AMUNT		= 0xDFEFDA,
	GMP_EXT_DEVICE_FIS_TAX_DETAIL_FOODCARD_MAX_PAYABLE_AMOUNT	= 0xDFEFDB,
	GMP_EXT_DEVICE_ODEME_UNIQUE_ID								= 0xDFEFE0,		/*16 BYTE CHAR */
	GMP_LAST_ITEM,

	GMP_EXT_DEVICE_ITEM_KONAKLAMA_VERGISI_ORAN					= 0xDFF047,		/**< 0xDFF047,  */
	GMP_EXT_DEVICE_ITEM_KONAKLAMA_VERGISI_TUTAR					= 0xDFF048,		/**< 0xDFF048,  */
	GMP_EXT_DEVICE_ITEM_KONAKLAMA_VERGISI_HARIC					= 0xDFF049,		/**< 0xDFF049,  */
	GMP_EXT_DEVICE_ITEM_KONAKLAMA_VERGISI_AKTIF					= 0xDFF04A,		/**< 0xDFF04A,  */

	GMP_EXT_DEVICE_LAST_TRANS_FLAG								= 0xDFF060,
	GMP_EXT_DEVICE_LAST_TRANS_DATE								= 0xDFF061,
	GMP_EXT_DEVICE_LAST_TRANS_TRANSACTION_FISCAL_TYPE			= 0xDFF062,
	GMP_EXT_DEVICE_LAST_TRANS_TICKET_TYPE						= 0xDFF063,
	GMP_EXT_DEVICE_LAST_TRANS_SOURCE_TYPE						= 0xDFF064,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_FLAG						= 0xDFF065,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_DATE						= 0xDFF066,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_TYPE						= 0xDFF067,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_SUB_TYPE					= 0xDFF068,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_ORG_AMOUNT				= 0xDFF069,
	GMP_EXT_DEVICE_LAST_TRANS__PAYMENT_ORG_AMOUNT_CURRENCY		= 0xDFF06A,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_PAY_AMOUNT				= 0xDFF06B,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_PAY_AMOUNT_CURENCY		= 0xDFF06C,
	GMP_EXT_DEVICE_LAST_TRANS_CASH_BACK_TL						= 0xDFF06D,
	GMP_EXT_DEVICE_LAST_TRANS_CASH_BACK_DOVIZ					= 0xDFF06E,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_BACH_NO					= 0xDFF06F,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_STAN						= 0xDFF070,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_BANK_DATE					= 0xDFF071,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_APP_BKM_ID				= 0xDFF072,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_AUTHORIZE_CODE			= 0xDFF073,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_TRANS_FLAG				= 0xDFF074,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_TERMINAL_ID				= 0xDFF075,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_MERCHANT_ID				= 0xDFF076,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_RRN						= 0xDFF077,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_ERROR_CODE				= 0xDFF078,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_ERROR_MESSAGE				= 0xDFF079,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_APP_ERROR_CODE			= 0xDFF07A,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT_APP_ERROR_MESSAGE			= 0xDFF07B,
	GMP_EXT_DEVICE_LAST_TRANS_PAYMENT							= 0xDFF07C,
	GMP_EXT_DEVICE_LAST_TRANS_TOTAL_REFUND						= 0xDFF07D,
	GMP_EXT_DEVICE_LAST_TRANS_TOTAL_REFUND_CURRENCY				= 0xDFF07E,
	GMP_EXT_DEVICE_LAST_TRANS_TYPE_OF_REFUND					= 0xDFF07F,
	GMP_EXT_DEVICE_LAST_TRANS_REVERS_PAYMENT					= 0xDFF080,
	GMP_EXT_DEVICE_LAST_TRANS_TOTAL_RECEIPT_AMOUNT				= 0xDFF081,
	GMP_EXT_DEVICE_LAST_TRANS_TOTAL_RECEIPT_TAX					= 0xDFF082,
	GMP_EXT_DEVICE_LAST_TRANS_Z_NO								= 0xDFF083,
	GMP_EXT_DEVICE_LAST_TRANS_F_NO								= 0xDFF084,
	GMP_EXT_DEVICE_LAST_TRANS_EKU_NO							= 0xDFF085
...
typedef enum
{
	...
	APP_ERR_DECREASE_CAN_NOT_APPLY								= 2126,
	APP_ERR_INCREASE_CAN_NOT_APPLY								= 2127,
	APP_ERR_INVALID_INVOICE_ENTRY								= 2128,
	APP_ERR_HEADER_CHANGE_NOT_SUPPORT_FOR_GIB_SUBE_CODE			= 2129,		/**< 2129, GIB Changed Sube Kodu rules, Change Header not supportet, GetErrorTurkishDescription() function returns "Header deðiþimi GIB Þube Kodu deðiþikliði sebebi ile desteklenmiyor." */
	...
	APP_ERR_GMP3_PAYMENT_STATUS_NO_AVAILABLE					= 2491,		/**< 2491,	APP_ERR_GMP3_PAYMENT_STATUS_NO_AVAILABLE				GetErrorTurkishDescription() function returns "Ödeme durumu mevcut deðil" */
	APP_ERR_GMP3_INVALID_TCKN_VKN								= 2492,		/**< 2492,	APP_ERR_GMP3_INVALID_TCKN_VKN							GetErrorTurkishDescription() function returns "Geçersiz Tckn/Vkn" */
	APP_ERR_GMP3_FOODCARD_VATRATE_MISMATCH						= 2493,		/**< 2493,	APP_ERR_GMP3_FOODCARD_VATRATE_MISMATCH					GetErrorTurkishDescription() function returns "Yemekçeki KDV oraný uyumsuzluðu" */
	APP_ERR_GMP3_FOODCARD_BIGGER_THAN_PAYABLE_AMOUNT			= 2494,		/**< 2494,	APP_ERR_GMP3_FOODCARD_BIGGER_THAN_PAYABLE_AMOUNT		GetErrorTurkishDescription() function returns "Girilen tutar yemekçeki ile ödenebilir tutardan büyük" */
	APP_ERR_GMP3_STOPPAGE_RATE_NOT_FOUND						= 2495,		/**< 2495,	APP_ERR_GMP3_STOPPAGE_RATE_NOT_FOUND					GetErrorTurkishDescription() function returns "Stopaj oraný bulunamadý" */
	APP_ERR_GMP3_CAN_NOT_ACCEPT_AFTER_HEADER_PRINTED			= 2496,		/**< 2496,	APP_ERR_GMP3_CAN_NOT_ACCEPT_AFTER_HEADER_PRINTED		GetErrorTurkishDescription() function returns "Bu iþlem fiþ baþlýðý basýldýktan sonra yapýlamaz" */
	APP_ERR_GMP3_INVALID_PAYMENT_INDEX							= 2497,		/**< 2497,	APP_ERR_GMP3_INVALID_PAYMENT_INDEX						GetErrorTurkishDescription() function returns "Geçersiz ödeme indeksi" */
	APP_ERR_GMP3_GET_SLIP_REQUEST_FAILED						= 2498,		/**< 2498,	APP_ERR_GMP3_GET_SLIP_REQUEST_FAILED					GetErrorTurkishDescription() function returns "Slip okuma talebi baþarýsýz" */
	APP_ERR_GMP3_GET_SLIP_RESPONSE_FAILED						= 2499,		/**< 2499,	APP_ERR_GMP3_GET_SLIP_RESPONSE_FAILED					GetErrorTurkishDescription() function returns "Slip okuma iþlemi baþarýsýz" */
	APP_ERR_GMP3_GET_SLIP_INVALID_INDEX							= 2500,		/**< 2500,	APP_ERR_GMP3_GET_SLIP_INVALID_INDEX						GetErrorTurkishDescription() function returns "Slip okuma indeksi geçersiz " */
	APP_ERR_ECR_RECEIPT_NOT_ALLOWED								= 2501,		/**< 2501,	APP_ERR_ECR_RECEIPT_NOT_ALLOWED							GetErrorTurkishDescription() function returns "ÖKC fiþi basma yekisi kapalý" */
	APP_ERR_INVOICE_INFO_RECEIPT_NOT_ALLOWED					= 2502,		/**< 2502,	APP_ERR_INVOICE_INFO_RECEIPT_NOT_ALLOWED				GetErrorTurkishDescription() function returns "Bilgi fiþi basma yetkisi kapalý" */
	APP_ERR_FOODCARD_INFO_RECEIPT_NOT_ALLOWED					= 2503,		/**< 2503,	APP_ERR_FOODCARD_INFO_RECEIPT_NOT_ALLOWED				GetErrorTurkishDescription() function returns "Yemekçeki bilgi fiþi basma yetkisi kapalý" */
	APP_ERR_PAY_AMOUNT_MISMATCH									= 2504,		/**< 2504,	APP_ERR_PAY_AMOUNT_MISMATCH								GetErrorTurkishDescription() function returns "Ödeme tutarý uyuþmazlýðý" */
	APP_ERR_INVALID_FOODCARD_VATRATE							= 2505,		/**< 2505,	APP_ERR_INVALID_FOODCARD_VATRATE						GetErrorTurkishDescription() function returns "Geçersiz yemekçeki KDV oraný" */
	APP_ERR_GMP3_TOTAL_FOODCARD_BIGGER_THAN_PAYABLE_AMOUNT		= 2506,		/**< 2506,	APP_ERR_GMP3_TOTAL_FOODCARD_BIGGER_THAN_PAYABLE_AMOUNT	GetErrorTurkishDescription() function returns "Toplam yemekçeki tutarý ödenebilir tutardan büyük" */
	APP_ERR_E_BILET_NO_PARAMETER_ENTRY							= 2507,		/**< 2507,	APP_ERR_E_BILET_NO_PARAMETER_ENTRY						GetErrorTurkishDescription() function returns "e-Bilet iþlemi için parametre giriþi yapýlmalý" */
	APP_ERR_E_BILET_INVALID_BILET_TYPE							= 2508,		/**< 2508,	APP_ERR_E_BILET_INVALID_BILET_TYPE						GetErrorTurkishDescription() function returns "Geçersiz e-Bilet tipi" */
	APP_ERR_SMM_INVALID_RATE									= 2509,		/**< 2509,	APP_ERR_SMM_INVALID_RATE								GetErrorTurkishDescription() function returns "Serbest meslek makbuzu geçersiz KDV oraný" */
	APP_ERR_E_BILET_ITEM_CAN_NOT_HAVE_A_NAME					= 2510,		/**< 2510,	APP_ERR_E_BILET_ITEM_CAN_NOT_HAVE_A_NAME				GetErrorTurkishDescription() function returns "e-Bilet ürününe ürün ismi atanamaz" */
	APP_ERR_INVALID_UNIT_TYPE									= 2511,		/**< 2511,	APP_ERR_INVALID_UNIT_TYPE								GetErrorTurkishDescription() function returns "Geçersiz birim tipi" */
	APP_ERR_PAYMENT_TYPE_MISMATCH								= 2512,		/**< 2512,	APP_ERR_PAYMENT_TYPE_MISMATCH							GetErrorTurkishDescription() function returns "Ödeme tipi uyuþmazlýðý" */
	APP_ERR_REVERSE_PAYMENT_CANNOT_VOID							= 2513,		/**< 2513,	APP_ERR_REVERSE_PAYMENT_CANNOT_VOID						GetErrorTurkishDescription() function returns "Ýptal/iade ödemesi iptal edilemez" */

	APP_ERR_TERMINAL_DATE_INVALID								= 2520,		/**< 2520,	APP_ERR_TERMINAL_DATE_INVALID							GetErrorTurkishDescription() function returns "Terminal tarih/saat bilgisi geçersiz" */
	APP_ERR_24H_RESET_TIME_DELAY_MUST_BIGGER					= 2521,		/**< 2521,	APP_ERR_24H_RESET_TIME_DELAY_MUST_BIGGER				GetErrorTurkishDescription() function returns "24 saat reset kuralý için belirtilen gecikme daha fazla olmalý" */
	APP_ERR_24H_RESET_TIME_DELAY_MUST_SMALLER					= 2522,		/**< 2522,	APP_ERR_24H_RESET_TIME_DELAY_MUST_SMALLER				GetErrorTurkishDescription() function returns "24 saat reset kuralý için belirtilen gecikme daha az olmalý" */
	APP_ERR_24H_RESET_INVALID_BEFORE_MANAGER_PARAMETER			= 2523,		/**< 2523,	APP_ERR_24H_RESET_INVALID_BEFORE_MANAGER_PARAMETER		GetErrorTurkishDescription() function returns "24 saat reset kuralý için geçersiz parametre" */
	APP_ERR_24H_RESET_INVALID_TIME_SET							= 2524,		/**< 2524,	APP_ERR_24H_RESET_INVALID_TIME_SET						GetErrorTurkishDescription() function returns "24 saat reset kuralý için belirtilen saat geçersiz" */

	APP_ERR_PAYMENT_APP_NOT_SELECTED							= 2530,		/**< 2530,	APP_ERR_PAYMENT_APP_NOT_SELECTED						GetErrorTurkishDescription() function returns "Ödeme uygulamasý seçilmedi." */

	APP_ERR_GMP3_NOT_ALLOWED_BEFORE_HEADER						= 2531,		/**< 2531,	APP_ERR_GMP3_NOT_ALLOWED_BEFORE_HEADER					GetErrorTurkishDescription() function returns "Fiþ baþlýðýnda önce mesaj yazdýrýlamaz" */
	APP_ERR_NOT_ALLOWED_VAT_RATE								= 2532,		/**< 2532,	APP_ERR_NOT_ALLOWED_VAT_RATE							GetErrorTurkishDescription() function returns "Ýþ yeri faaliyet alaný için yetkisiz KDV oraný." */
	APP_ERR_EXPIRED_EXCHANGE_RATE								= 2533,		/**< 2533,	APP_ERR_EXPIRED_EXCHANGE_RATE							GetErrorTurkishDescription() function returns "Döviz kuru tarihi geçmiþ." */

	APP_ERR_NOT_FOUND											= 2540,
	APP_ERR_NOT_MEMORY_ERROR									= 2541,

	// MasterOKC Hata kodlari
	APP_ERR_BACKGROUND_LOADING_NOT_ALLOWED						= 2550,
	APP_ERR_BACKGROUND_TICKETHEADER_NOT_FOUND					= 2551,
	APP_ERR_BACKGROUND_DB_READ_ERROR							= 2552,
	APP_ERR_BACKGROUND_DB_READ_LENGTH_ERROR						= 2553,
	APP_ERR_NOT_ALLOWED_IN_BACKGROUND_MODE						= 2554,
	APP_ERR_SIGN_NOT_VALIDATED									= 2555,
	APP_ERR_TRANSACTION_ALREADY_COMPLATED						= 2556,
	APP_ERR_INVALID_HANDLE_STATUS								= 2557,
	APP_ERR_BACKGROUND_HANDLE_NOT_FOUND							= 2558,
	...
	DLL_RETCODE_KEEP_ALIVE_TIMEOUT								= 0xF03F,	/**< , KEEP ALIVE TIMEOUT,														GetErrorTurkishDescription() function returns "Zaman Aþýmý" */
	DLL_RETCODE_NOT_SUPPORTED									= 0xF040	/**< , NOT SUPPORT,														GetErrorTurkishDescription() function returns "Zaman Aþýmý" */
} EGlobalReturnCodes;

/** Types of the payment */
#define PAYMENT_ALL									0xFFF00000000FFFFFLL       //  NAKIT  KREDI  OTHER  YCEKI  DOVIZ   MATRAH  MENU    (ODEME TIPLERI)
#define PAYMENT_CASH_TL								0x0000000000000001LL       // 	++++   xxxx   xxxx   xxxx   xxxx    ++++	xxxx
#define PAYMENT_CASH_CURRENCY						0x0000000000000002LL       // 	xxxx   xxxx   xxxx   xxxx   ++++    ++++    xxxx
#define PAYMENT_BANK_CARD							0x0000000000000004LL       //	xxxx   ++++   xxxx   xxxx   xxxx    ++++    xxxx
#define PAYMENT_YEMEKCEKI							0x0000000000000008LL       //	xxxx   xxxx   xxxx   ++++   xxxx    xxxx    xxxx    (Uygulama varsa)
#define PAYMENT_MOBILE								0x0000000000000010LL       // 	xxxx   ++++   xxxx   xxxx   xxxx    ++++    xxxx    (Uygulama varsa)
#define PAYMENT_HEDIYE_CEKI							0x0000000000000020LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_IKRAM								0x0000000000000040LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_ODEMESIZ							0x0000000000000080LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_KAPORA								0x0000000000000100LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_PUAN								0x0000000000000200LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_GIDER_PUSULASI						0x0000000000000400LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_BANKA_TRANSFERI						0x0000000000000800LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_CEK									0x0000000000001000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_ACIK_HESAP							0x0000000000002000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_DIGER								0x0000000000004000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_EXTERNAL_BANK						0x0000000000008000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_SANAL_POS							0x0000000000010000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_EPARA_HIZLI_PARA					0x0000000000020000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_ULASIM_KARTI						0x0000000000040000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_COMBINED							0x0000000000080000LL       // 	xxxx   xxxx   ++++   xxxx   xxxx    ++++    ++++
#define PAYMENT_TR_KAREKOD_CARD						0x0010000000000000LL
#define PAYMENT_TR_KAREKOD_FAST						0x0020000000000000LL
#define PAYMENT_TR_KAREKOD_MOBIL					0x0040000000000000LL
#define PAYMENT_TR_KAREKOD_DIGER					0x0080000000000000LL

#define REVERSE_PAYMENT_ALL							0x000FFFFFFFF00000LL
#define REVERSE_PAYMENT_CASH						0x0000000000100000LL
#define REVERSE_PAYMENT_BANK_CARD_VOID				0x0000000000200000LL
#define REVERSE_PAYMENT_BANK_CARD_REFUND			0x0000000000400000LL
#define REVERSE_PAYMENT_YEMEKCEKI					0x0000000000800000LL
#define REVERSE_PAYMENT_MOBILE						0x0000000001000000LL
#define REVERSE_PAYMENT_HEDIYE_CEKI					0x0000000002000000LL
#define REVERSE_PAYMENT_PUAN						0x0000000004000000LL
#define REVERSE_PAYMENT_ACIK_HESAP					0x0000000008000000LL
#define REVERSE_PAYMENT_KAPORA						0x0000000010000000LL
#define REVERSE_PAYMENT_GIDER_PUSULASI				0x0000000020000000LL
#define REVERSE_PAYMENT_BANKA_TRANSFERI				0x0000000040000000LL
#define REVERSE_PAYMENT_CEK							0x0000000080000000LL
#define REVERSE_PAYMENT_IKRAM						0x0000000100000000LL
#define REVERSE_PAYMENT_ODEMESIZ					0x0000000200000000LL
#define REVERSE_PAYMENT_DIGER						0x0000000400000000LL
#define REVERSE_TR_KAREKOD_CARD						0x0000000800000000LL
#define REVERSE_TR_KAREKOD_FAST						0x0000001000000000LL
#define REVERSE_TR_KAREKOD_MOBIL					0x0000002000000000LL
#define REVERSE_TR_KAREKOD_DIGER					0x0000004000000000LL

typedef uint64		EPaymentTypes;
...
#define FLAG_ING_PARAM_DISABLE_PLU_GIRISLI_SATIS		(1 << 0)
#define FLAG_ING_PARAM_DISABLE_DEPT_GIRISLI_SATIS		(1 << 1)
#define FLAG_ING_PARAM_DISABLE_SERB_GIRISLI_SATIS		(1 << 2)
#define FLAG_ING_PARAM_DISABLE_INDIRIM_ARTTIRIM			(1 << 3)
#define FLAG_ING_PARAM_DISABLE_MANUAL_SATIS				(1 << 4)
#define FLAG_ING_PARAM_DISABLE_KREDILI_AVANS_ODEME		(1 << 5)
#define FLAG_ING_PARAM_DISABLE_TAXLESS					(1 << 6)
#define FLAG_ING_PARAM_ENABLE_REFUND_ITEM			    (1 << 7)
#define FLAG_ING_PARAM_ENABLE_REFUND_SINEMA_TICKET		(1 << 8)
#define FLAG_ING_PARAM_ENABLE_F_MENU_PASSWORD 			(1 << 9)
#define FLAG_ING_PARAM_DISABLE_KREDILI_CARI_HESAP_ODEME (1 << 10)
#define FLAG_ING_PARAM_DISABLE_KIBRIS_OFFLINE_BANKA		(1 << 11)
#define FLAG_ING_PARAM_DISABLE_ECR_RECEIPT				(1 << 12)
#define FLAG_ING_PARAM_DISABLE_INVOICE_INFO_RECEIPT		(1 << 13)
#define FLAG_ING_PARAM_DISABLE_FOOCARD_INFO_RECEIPT		(1 << 14)
#define FLAG_ING_PARAM_DISABLE_USER_MES_BEFORE_HEADER	(1 << 15)
#define FLAG_ING_PARAM_DISABLE_BANKA_MENU				(1 << 16)
#define FLAG_ING_PARAM_DISABLE_SEKTOREL_MENU			(1 << 17)
...
typedef enum
{
	BANK_TRAN_FLAG_SOFT_COPY_SUPPORT_FOR_MERCHANT_COPY			= 0x00080000,   /**< 0x00080000 Payment aplication doesn't print merchant copy if support soft copy. */
...
typedef struct _ST_ECHO
{
	...
	char		szEcrVersion[15 + 1];			/**< ECR SW Version */
	char		szEcrNewVersion[15 + 1];		/**< ECR SW Version */
	uint16		EkuNo;							/**< Current EKU No */
	uint16		ZNo;							/**< Current Z No */
	uint16		FisNo;							/**< Current FIS No */
	uint64		Handle;							/**< Current transaction Handle */
	uint8		UniqueID[24];					/**< Current transaction Unique ID */
	ST_DATE		date;							/**< Date */
	ST_TIME		time;							/**< Time */
	ST_CASHIER	activeCashier;					/**< Active cashier information */
} ST_ECHO;

typedef struct _ST_CLOSE
{
	uint32		StructSize;						/**< Sizeof this structure */
	uint16		EkuNo;							/**< Current EKU No */
	uint16		ZNo;							/**< Current Z No */
...
typedef struct _ST_GMP_PAIR_RESP
{
	...
	char		szNewVersionNumber[8 + 1];	/**< ECR Version Number */
	char		szHashFirstDate[8 + 1];		/**< Used HASH First Usable Date */
	char		szHashLastDate[8 + 1];		/**< Used HASH Last Usable Date */
	char		szHashExpireDate[8 + 1];	/**< Used HASH Expire Date */
} ST_GMP_PAIR_RESP;
...
typedef struct _InitStruct
{
	...
	char ecr_ecrBrand[16];				/**< Brand name of ECR, WORLDLINE */
...
typedef struct _ST_ITEM
{
	...
	uint32  Reserved;				/**< it  */
	uint8	szDate[6 + 1];			/**< Date in unix format which is used on ITEM_TYPE_MONEYCOLLECTION types to print on the ticket in FATURA TAHSILAT transaction, currenct ony used by ITEM_TYPE_MONEYCOLLECTION */
	struct
	{
...
typedef struct _ST_SALEINFO
{
	...
	char	Name[32+1];					/**< Optional name of the item to print on the ticket. if not provided Department default name or PLU record name is used to print on ticket */
	char	Barcode[32+1];				/**< Optional barcode of the item (it is mandotary for ITEM_TYPE_PLU) */
	uint16	AccommodationTaxRate;
	uint64	AccommodationTaxAmount;
	uint8	IsExcludingAccommodationTax;
} ST_SALEINFO;
...
#define COMBINED_SUBPAYMENT_COUNT   4
#define MAX_TAXRATE_COUNT			8
typedef struct
{
	uint8	Type;
	uint8	SubType;
	uint8	countOfSubPayment;
	uint32	Amount;
	char	szTransCode[31 + 1];
	struct
	{
		uint8 	PaymentType;//
		uint16 	currencyCode;
		uint32 	Amount;
		char 	szAcquirerID[8 + 1];
		char 	szIssuerID[8 + 1];
		char 	szAuthorizationCode[20 + 1];
		uint8 	InstalmentCount;
		char 	szInstalmentDesc[40 + 1];
		char 	szDescription[32 + 1];
		uint8	VatCount;
		struct
		{
			uint16 	VatRate;
			uint32 	PaymentAmount;
		} stKdv[MAX_TAXRATE_COUNT];
	} stPayment[COMBINED_SUBPAYMENT_COUNT];
} ST_CombinedPayment; // 760
...
typedef struct _ST_BANK_PAYMENT_INFO
{
	...
	ST_CombinedPayment stCombinedPayment;
...
typedef struct _ST_PAYMENT
{
	...
	uint64 	typeOfPayment;				/**< One of EPaymentTypes */
	...
	uint32	tipAmount;					/**< TIP amount */
	uint8	tipItemIndex;				/**< Item index which is added for TIP */
...
typedef struct _ST_PCI_24H_RESET_INFO
{
	uint32	StructSize;
	uint8   szStartTime[4 + 1];											/**< 24H Reset start time as ASCII HHMM */
	uint8   szEndTime[4 + 1];											/**< 24H Reset end time as ASCII HHMM */
	uint8   BeforeManager;												/**< 24H Reset before manager time as Integer. Value shuld be betveen in 20 to 250 min. Default is 30 min.*/
} ST_PCI_24H_RESET_INFO;

#define MAX_KDV_COUNT			8
typedef struct _ST_ALLOWED_KDV_INFO
{
	uint32	StructSize;
	uint8	KdvCount;
	uint16	KdvList[MAX_KDV_COUNT];
} ST_ALLOWED_KDV_INFO;

#define MAX_NACE_COUNT			120
typedef struct _ST_NACE_INFO
{
	uint32	StructSize;
	uint8	NaceCount;
	char	NaceList[MAX_NACE_COUNT][7]; // XX XX XX + NULL
} ST_NACE_INFO;

#define MAX_PAYMENT_COUNT					24
typedef struct _ST_LAST_TRANS_INFO
{
	uint32		StructSize;
	uint32 		Flags;											// bilet satisinda kullaniliyor ve VAS, TAX FREE uygulamalarinda
	char 		DateOfTransaction[14 + 1];
	uint8		transactionFiscalType;							//! ETransactionFiscalType
	uint8 		ticketType;										//
	uint8	    SourceType;										//! One of ETransactionSource
	struct ST_LAST_TRANS_PAYMENT
	{
		uint8 	flags;											// 0x01: Canceled
		char	dateOfPayment[14 + 1];							// uint32 time of the payment (not necassary to be the same time of transaction)
		uint64 	typeOfPayment;									// one of "", "PAYMENT_BANK_CARD", "PAYMENT_CURRENCY", "PAYMENT_YEMEKCEKI"
		uint8	subtypeOfPayment;								// Exp:YEMEKCEKI firmasi
		uint32	orgAmount;										// Exp; Currency Amount
		uint16	orgAmountCurrencyCode;							// as defined in currecyTable from GIB
		uint32	payAmount;										// always TL with precision 2
		uint16	payAmountCurrencyCode;							// always TL
		uint32  cashBackAmountInTL;								// Para üstü, her zaman TL with precision 2
		uint32  cashBackAmountInDoviz;							// Para Üstü, döviz satýþ ise döviz karþýlýðý
		struct ST_LAST_TRANS_BANK_PAYMENT_INFO
		{
			uint32  batchNo;
			uint32  stan;
			char	datetime[14 + 1];
			uint16  bankBkmId;
			char	authorizeCode[6 + 1];
			uint16  transFlag;
			char	terminalId[8 + 1];
			char	merchantId[15 + 1];
			char    rrn[12 + 1];
			struct ST_LastTransPaymentErrMessage
			{
				char   ErrorCode[4 + 1];						// bank error code
				char   ErrorMsg[40 + 1];
				char   AppErrorCode[4 + 1];						// payment application specific error code
				char   AppErrorMsg[40 + 1];
			}		stPaymentErrMessage;
		} stBankPayment;										// Keeps all payment info related with bank
	} stPayment[MAX_PAYMENT_COUNT];
	struct ST_LAST_TRANS_REVERSE_PAYMENT
	{
		uint32	AmountTobeRefund;					  			//AmountTobeRefund[6]; bcd tag 20
		uint16 	currencyOfRefundAmount;
		uint64 	TypeOfRefund;									// one of "REVERSE_", "REVERSE_PAYMENT_BANK_CARD",  "REVERSE_PAYMENT_YEMEKCEKI" ...
		uint16  BkmId;											// banka uygulamasi ise bkm Id, VAS icin telium id kullanilir...
		char 	Rrn[12 + 1]; 									//ascii tag 46
		char 	AuthorizationNumber[6 + 1];						// ascii
		char 	TerminalId[8 + 1];							 	//ascii for multimerchant
		uint32  Batch;
		uint32  Stan;
		uint32  flags;
	}			stReversePayment;
	uint64  	TotalReceiptAmount;
	uint64  	TotalReceiptTax;
	uint16 		ZNo;
	uint16 		FNo;
	uint16 		EkuNo;
} ST_LAST_TRANS_INFO;

typedef struct _ST_SMM_DATA
{
	uint32	StructSize;
	uint8	AdiSoyadi[32];
	uint8	Unvan[32];
...
typedef struct _ST_SMM_BILGI_FISI_DATA
{
	uint32	StructSize;
	uint8	AdiSoyadi[48 + 1];
	uint8	Adres[96 + 1];
	uint8	VknTckn[11 + 1];
	uint8	ETTN[36 + 1];
	uint16	StopajOrani;
	uint16	TevkifatOrani;
} ST_SMM_BILGI_FISI_DATA;

typedef struct _ST_GIDER_PUSULASI
{
	uint32	StructSize;
	uint32	Amount;
	char	AliciAdiSoyadi[32];
	char	AliciAdres[128];
	char	AliciUnvan[32];
	char	SaticiAdiSoyadi[32];
	char	FaturaSeri[24 + 1];
	char	FaturaSira[42 + 1];
	char	FaturaTarih[16];
	uint16	StopajOrani;
	uint16	Adet;
	char	Nevi[32];
...
{
	uint32	StructSize;
	char 	IrsaliyeNo[16 + 1];
	char 	ETTN[36 + 1];
	char 	CustomerTCKN_VKN[11 + 1];
	char 	CustomerName[48 + 1];
	char 	CustomerAdress[96 + 1];
	char 	DriverTCKN_VKN[11 + 1];
	char 	DriverName[48 + 1];
	char 	VehiclePlate[12 + 1];
	uint32 	TransferDate;
} ST_E_IRSALIYE_BILGI;
...
typedef struct _ST_TICKET
{
	...
	char 	GiderPusulasiBelgeSeri[24 + 1];						/**< */
	char 	GiderPusulasiBelgeSira[42 + 1];						/**< */
...
typedef struct _ST_INVIOCE_INFO
{
	uint32	StructSize;							/**< Sizeof this structure */
...
typedef struct
{
	...
	uint32  AppOpt1;							/**< Application Option 1 */
	uint32  AppOpt2;							/**< Application Option 2 */
	uint64	SupportedPayments;					/**< bitwise value for supported payments*/
	char	Version[15 + 1];					/**< app version*/
...
#define MAX_GIB_BILGI_FISI_TIPI		15
#define MAX_GIB_ODEME_TIPI			16
#define MAX_GIB_BELGE_TIPI			7

typedef enum
{
	T_ZReport_IT_PaperInvoice = 1,
	T_ZReport_IT_E_Invoice = 2,
	T_ZReport_IT_FoodCard = 3,
	T_ZReport_IT_CustomerAdvance = 4,
	T_ZReport_IT_Otopark = 5,
	T_ZReport_IT_MoneyCollection = 6,
	T_ZReport_IT_CurrentAccount = 7,
	T_ZReport_IT_SMM = 8,
	T_ZReport_IT_ExpenseTicket = 9,

	T_ZReport_IT_E_ArchiveInvoice = 64,
	T_ZReport_IT_TaxFree = 65,
	T_ZReport_IT_CashAdvance = 66,
	T_ZReport_IT_CashPayment = 67,
	T_ZReport_IT_E_Ticket = 68,
	T_ZReport_IT_E_WayBill = 69,

} TZReportInfoTicketType;

typedef enum
{
	T_ZReport_Document_ECRReceipt = 1,
	T_ZReport_Document_Invoice = 2,
	T_ZReport_Document_SMM = 3,
	T_ZReport_Document_ExpenseDocument = 4,
	T_ZReport_Document_MM = 5,
	T_ZReport_Document_Ticket = 6,
	T_ZReport_Document_Void = 7,

} TZReportDocumentType;

typedef enum
{
	T_ZReport_Payment_Cash = 0,
	T_ZReport_Payment_Credit = 1,
	T_ZReport_Payment_VirtualPos = 2,
	T_ZReport_Payment_TransferEft = 3,
	T_ZReport_Payment_E_MoneyFastMoney = 4,
	T_ZReport_Payment_CheckBillOpenAccount = 5,
	T_ZReport_Payment_GiftCard = 6,
	T_ZReport_Payment_TransportCard = 7,
	T_ZReport_Payment_FoodCard = 8,
	T_ZReport_Payment_Tr_QR_Card = 9,
	T_ZReport_Payment_Tr_QR_Fast = 10,
	T_ZReport_Payment_Tr_QR_Mobile = 11,
	T_ZReport_Payment_Tr_QR_Other = 12,

	T_ZReport_Payment_OtherWorldLine = 64,
	T_ZReport_Payment_Mobile = 65,
	T_ZReport_Payment_Point = 66,
} TZReportPaymentType;
...
#define TAG_IKASA_OKC_NEW_ZREPORT_DATA						0x809A
...
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_CARD_AMOUNT		0xA210
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_CARD_COUNT			0xA211
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_FAST_AMOUNT		0xA212
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_FAST_COUNT			0xA213
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_MOBILE_AMOUNT		0xA214
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_MOBILE_COUNT		0xA215
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_OTHER_AMOUNT		0xA216
#define TAG_IKASA_OKC_ZREPORT_TR_KAREKOD_OTHER_COUNT		0xA217
#define TAG_IKASA_OKC_ZREPORT_E_PARA_AMOUNT					0xA218
#define TAG_IKASA_OKC_ZREPORT_E_PARA_COUNT					0xA219

#define TAG_IKASA_OKC_ZREPORT_KONAKLAMA_VERGISI_ORAN		0xA220
#define TAG_IKASA_OKC_ZREPORT_KONAKLAMA_VERGISI_TUTAR		0xA222
#define TAG_IKASA_OKC_URUN_KONAKLAMA_VERGISI_TUTARI			0xA223
#define TAG_IKASA_OKC_URUN_KONAKLAMA_VERGISI_ORANI			0xA224
#define TAG_IKASA_OKC_URUN_KONAKLAMA_VERGISI_HARIC			0xA225
#define TAG_IKASA_OKC_RECEIPT_KONAKLAMA_VERGISI_TOPLAM		0xA226

#define TAG_IKASA_OKC_GIDER_PSL_BRUT_TOPLAM					0xA230
#define TAG_IKASA_OKC_GIDER_PSL_KDV_TOPLAM					0xA231
#define TAG_IKASA_OKC_GIDER_PSL_STOPAJ_TOPLAM				0xA232
#define TAG_IKASA_OKC_GIDER_PSL_TAHSILAT_TOPLAM				0xA234
#define TAG_IKASA_OKC_GIDER_PSL_STOPAJ_ORANI				0xA235
#define TAG_IKASA_OKC_GIDER_PSL_BELGE_SERI					0xA236
#define TAG_IKASA_OKC_GIDER_PSL_BELGE_SIRA					0xA237
#define TAG_IKASA_OKC_GIDER_PSL_FATURA_BILGI_SERI			0xA238
#define TAG_IKASA_OKC_GIDER_PSL_FATURA_BILGI_SIRA			0xA239
#define TAG_IKASA_OKC_GIDER_PSL_FATURA_BILGI_TARIH			0xA23A
#define TAG_IKASA_OKC_GIDER_PSL_ALICI_AD_SOYAD 				0xA23B
#define TAG_IKASA_OKC_GIDER_PSL_ALICI_UNVAN					0xA23C
#define TAG_IKASA_OKC_GIDER_PSL_ALICI_ADRES					0xA23D
#define TAG_IKASA_OKC_GIDER_PSL_SATICI_AD_SOYAD				0xA23E

#define TAG_IKASA_OKC_ITEM_VERGI_INFO_BRUT_TUTAR			0xA250
#define TAG_IKASA_OKC_ITEM_VERGI_INFO_STOPOAJ_TUTAR			0xA251


#define TAG_IKASA_OKC_Z_REPORT_VERSIYON										0xA260  // uint16 2 byte
#define TAG_IKASA_OKC_Z_REPORT_FLAG											0xA261
#define TAG_IKASA_OKC_Z_REPORT_TARIH										0xA262
#define TAG_IKASA_OKC_Z_REPORT_SAAT											0xA263
#define TAG_IKASA_OKC_Z_REPORT_FIS_SIRA_NO									0xA264
#define TAG_IKASA_OKC_Z_REPORT_Z_SAYAC_NO									0xA265
#define TAG_IKASA_OKC_Z_REPORT_EKU_NO										0xA266
#define TAG_IKASA_OKC_Z_REPORT_ARTTIRIM_TOPLAM_ADEDI						0xA267
#define TAG_IKASA_OKC_Z_REPORT_ARTTIRIM_TOPLAM_TUTARI						0xA268
#define TAG_IKASA_OKC_Z_REPORT_INDIRIM_TOPLAM_ADEDI							0xA269
#define TAG_IKASA_OKC_Z_REPORT_INDIRIM_TOPLAM_TUTARI						0xA26A
#define TAG_IKASA_OKC_Z_REPORT_HATA_DUZELT_TOPLAM_ADEDI						0xA26B
#define TAG_IKASA_OKC_Z_REPORT_HATA_DUZELT_TOPLAM_TUTARI					0xA26C
#define TAG_IKASA_OKC_Z_REPORT_MALI_FIS_ADETI								0xA26D
#define TAG_IKASA_OKC_Z_REPORT_MALI_OLMAYAN_FIS_ADEDI						0xA26E
#define TAG_IKASA_OKC_Z_REPORT_MUSTERI_FIS_ADEDI							0xA26F
#define TAG_IKASA_OKC_Z_REPORT_SATIS_FISI_IPTAL_ADEDI						0xA270
#define TAG_IKASA_OKC_Z_REPORT_SATIS_IPTAL_TOPLAM_TUTARI					0xA271
#define TAG_IKASA_OKC_Z_REPORT_BILGI_FISI_KAGIT_FATURA_KAYDI				0xA272

#define TAG_IKASA_OKC_Z_REPORT_BILGI_FISI_KAYDI							    0xA280
#define TAG_IKASA_OKC_Z_REPORT_BILGI_FISI_DETAY_TIP							0xA281
#define TAG_IKASA_OKC_Z_REPORT_BILGI_FISI_DETAY_ADET						0xA282
#define TAG_IKASA_OKC_Z_REPORT_BILGI_FISI_DETAY_NAKIT_ODEME					0xA283
#define TAG_IKASA_OKC_Z_REPORT_BILGI_FISI_DETAY_BANKA_ODEME					0xA284
#define TAG_IKASA_OKC_Z_REPORT_BILGI_FISI_DETAY_DIGER_ODEME					0xA285

#define TAG_IKASA_OKC_Z_REPORT_BELGE_KAYDI									0xA290
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_TIP								0xA291
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_TOPLAM_ADEDI						0xA292
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_TOPLAM_SATIS_TUTARI				0xA293
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_NAKIT_ODEME						0xA294
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_BANKA_ODEME						0xA295
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_DIGER_ODEME						0xA296
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_VERGI_1							0xA297
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_VERGI_2							0xA298
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_VERGI_3							0xA299
#define TAG_IKASA_OKC_Z_REPORT_BELGE_DETAY_VERGI_4							0xA29A

#define TAG_IKASA_OKC_Z_REPORT_ODEME_KAYDI									0xA2A0
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_TIP					0xA2A1
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_ADEDI				0xA2A2
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_KAYDI				0xA2A3
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_INDEX				0xA2A4
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_KISALTMASI			0xA2A5
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_ODEME_ADEDI			0xA2A6
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_TOPLAM_TUTAR			0xA2A7
#define TAG_IKASA_OKC_Z_REPORT_ODEME_DETAY_PARA_BIRIMI_TOPLAM_TL_KARSILIGI	0xA2A8

#define TAG_IKASA_OKC_Z_REPORT_KDV_KAYDI									0xA2B0
#define TAG_IKASA_OKC_Z_REPORT_KDV_DETAY_VERGI_DISI_TOPLAM_TUTAR			0xA2B1
#define TAG_IKASA_OKC_Z_REPORT_KDV_DETAY_INDEX								0xA2B2
#define TAG_IKASA_OKC_Z_REPORT_KDV_DETAY_VERGI_ORANI						0xA2B3
#define TAG_IKASA_OKC_Z_REPORT_KDV_DETAY_VERGI_TOPLAM_TUTARI				0xA2B4
#define TAG_IKASA_OKC_Z_REPORT_KDV_DETAY_TOPLAM_KDV							0xA2B5

#define TAG_IKASA_OKC_Z_REPORT_SERVIS_MUDAHALE_SAYISI						0xA2C0
#define TAG_IKASA_OKC_Z_REPORT_TOPLAM_TUTAR									0xA2C1
#define TAG_IKASA_OKC_Z_REPORT_TOPLAM_KDV									0xA2C2
#define TAG_IKASA_OKC_Z_REPORT_KUMULE_TOPLAM_TUTAR							0xA2C3
#define TAG_IKASA_OKC_Z_REPORT_KUMULE_TOPLAM_KDV							0xA2C4

#define TAG_IKASA_OKC_Z_REPORT_OKC_VERSIYON									0xA2D0
#define TAG_IKASA_OKC_Z_REPORT_OKC_VKN										0xA2D1
#define TAG_IKASA_OKC_Z_REPORT_OKC_FISCAL_MAP_USED							0xA2D2
#define TAG_IKASA_OKC_Z_REPORT_OKC_FISCAL_MAP_FREE							0xA2D3
#define TAG_IKASA_OKC_Z_REPORT_OKC_FISCAL_DATA_USED							0xA2D4
#define TAG_IKASA_OKC_Z_REPORT_OKC_FISCAL_DATA_FREE							0xA2D5
#define TAG_IKASA_OKC_Z_REPORT_OKC_EKU_MAP_USED								0xA2D6
#define TAG_IKASA_OKC_Z_REPORT_OKC_EKU_MAP_FREE								0xA2D7
#define TAG_IKASA_OKC_Z_REPORT_OKC_EKU_DATA_USED							0xA2D8
#define TAG_IKASA_OKC_Z_REPORT_OKC_EKU_DATA_FREE							0xA2D9

#define TAG_IKASA_OKC_Z_REPORT_DEPARTMAN_KAYDI								0xA2E0
#define TAG_IKASA_OKC_Z_REPORT_DEPARTMAN_DETAY_INDEX						0xA2E1
#define TAG_IKASA_OKC_Z_REPORT_DEPARTMAN_DETAY_ADI							0xA2E2
#define TAG_IKASA_OKC_Z_REPORT_DEPARTMAN_DETAY_TOPLAM_TUTAR					0xA2E3
#define TAG_IKASA_OKC_Z_REPORT_DEPARTMAN_DETAY_SATIS_ADEDI					0xA2E4
#define TAG_IKASA_OKC_Z_REPORT_DEPARTMAN_DETAY_KDV_ORANI					0xA2E5

#define TAG_IKASA_OKC_Z_REPORT_KASIYER_KAYDI								0xA2E6
#define TAG_IKASA_OKC_Z_REPORT_KASIYER_DETAY_INDEX							0xA2E7
#define TAG_IKASA_OKC_Z_REPORT_KASIYER_DETAY_ADI							0xA2E8
#define TAG_IKASA_OKC_Z_REPORT_KASIYER_DETAY_TOPLAM_TUTAR					0xA2E9

#define TAG_IKASA_OKC_Z_REPORT_IADE_ODEME_KAYDI								0xA2EA
#define TAG_IKASA_OKC_Z_REPORT_IADE_ODEME_DETAY_TIP							0xA2EB
#define TAG_IKASA_OKC_Z_REPORT_IADE_ODEME_DETAY_ODEME_ADEDI					0xA2EC
#define TAG_IKASA_OKC_Z_REPORT_IADE_ODEME_DETAY_TOPLAM_TUTAR				0xA2ED

#define TAG_IKASA_OKC_Z_REPORT_MATRAHSIZ_TOPLAM_ODEME						0xA2F0
#define TAG_IKASA_OKC_Z_REPORT_MATRAHSIZ_TOPLAM_ADET						0xA2F1
#define TAG_IKASA_OKC_Z_REPORT_MATRAHSIZ_TOPLAM_NAKIT_ODEME_TOPLAMI			0xA2F2
#define TAG_IKASA_OKC_Z_REPORT_MATRAHSIZ_TOPLAM_KREDI_ODEME_TOPLAMI			0xA2F3
#define TAG_IKASA_OKC_Z_REPORT_MATRAHSIZ_TOPLAM_DIGER_ODEME_TOPLAMI			0xA2F4

#define TAG_IKASA_OKC_Z_REPORT_ODEME_ALINAN_UYGULAMA_KAYDI					0xA2F5
#define TAG_IKASA_OKC_Z_REPORT_ODEME_ALINAN_UYGULAMA_DETAY_INDEX			0xA2F6
#define TAG_IKASA_OKC_Z_REPORT_ODEME_ALINAN_UYGULAMA_DETAY_APP_ID			0xA2F7
#define TAG_IKASA_OKC_Z_REPORT_ODEME_ALINAN_UYGULAMA_DETAY_TOPLAM_TUTAR		0xA2F8

#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_KAYDI							0xA310
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_INDEX						0xA311
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_KDV_ORANI					0xA312
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_SATIS_TIPI_KOLTUK_SAYISI	0xA313
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_SATIS_TIPI_TOPLAM_SATIS	0xA314
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_SATIS_TIPI_TOPLAM_KDV		0xA315
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_IADE_TIPI_KOLTUK_SAYISI	0xA316
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_IADE_TIPI_TOPLAM_SATIS	0xA317
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_IADE_TIPI_TOPLAM_KDV		0xA318
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_FATURA_TIPI_KOLTUK_SAYISI	0xA319
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_FATURA_TIPI_TOPLAM_SATIS	0xA31A
#define TAG_IKASA_OKC_Z_REPORT_SINEMA_BILET_DETAY_FATURA_TIPI_TOPLAM_KDV	0xA31B
...
// Bank Application Transaction Flag byte 0
#define IMP_APP_TRANS_INFO_FLAG_DEBIT_CARD								0x80
#define IMP_APP_TRANS_INFO_FLAG_INTERNATIONAL_CARD						0x40
#define IMP_APP_TRANS_INFO_FLAG_CARD_IN_CHIP_READER						0x20
#define IMP_APP_TRANS_INFO_FLAG_VALIDATOR_AKTARMA_ISLEM					0x10
#define IMP_APP_TRANS_INFO_FLAG_VALIDATOR_NO_CONNECTTION_FOR_SETTLEMENT	0x08
#define IMP_APP_TRANS_INFO_FLAG_FALLBACK_TO_MAGSTIPE					0x04
#define IMP_APP_TRANS_INFO_FLAG_SALE_WITHOUT_CAMPAIGN					0x02
#define IMP_APP_TRANS_INFO_FLAG_ONUS_CARD                   			0x01		// On us kartlarla iþlem yapýldýðýnda iþaretlenir
// Bank Application Transaction Flag byte 1
#define IMP_APP_TRANS_INFO_FLAG_APPROVED_OFFLINE						0x80
#define IMP_APP_TRANS_INFO_FLAG_APPROVED								0x40		// Kasa tarafý bu bayraða bakarak onaylanýp onaylanmadýðýný kontrol edecek.
#define IMP_APP_TRANS_INFO_FLAG_TRANSACTION_VOIDED						0x20		// Only for Transaction Inquiry
#define IMP_APP_TRANS_INFO_FLAG_PIN_USED								0x10
#define IMP_APP_TRANS_INFO_FLAG_SIGNATURE_REQUIRED						0x08
#define IMP_APP_TRANS_INFO_FLAG_NOT_PRINT_CARD_HOLDER_COPY				0x04
#define IMP_APP_TRANS_INFO_FLAG_NOT_PRINT_MERCHANT_COPY					0x02
#define IMP_APP_TRANS_INFO_FLAG_AMOUNT_FROM_ECR							0x01
...
typedef struct
{
	uint64 VatTotal;
	uint64 OTV_Total;
	uint64 PartialVatTotal;
	uint64 TaxAmount_4;
} ST_TaxInvoiceDocument;

typedef struct
{
	uint64 VatTotal; //RECEP BURDA KALDIN
	uint64 PartialVatTotal;
	uint64 WithholdingTotal;
	uint64 TaxAmount_4;
} ST_TaxSMM;
...
{
	uint64 WithholdingTotal;
	uint64 MeraFundTotal;
	uint64 StockExchangeTotal;
	uint64 SGK_PaymentTotal;
} ST_TaxMM;
...
typedef	struct
{
	...
	union
	{
		ST_TaxEcrReceipt	stECRReceipt;
		ST_TaxSMM 			stSMM;
		ST_TaxMM			stMM;
		ST_TaxExpense 		stGider;
		ST_TaxTicket 		stBilet;
		ST_TaxInvoiceDocument 	stFatura;
	} unTax;
...
typedef struct
{
	...
	struct
	{
		...
		uint16 PaymentCount;
		uint64 TotalAmount;
		uint64 TotalAmountInTL;
	} stCurrency[MAX_EXCHANGE_COUNT];
} ST_PaymentInfo;

typedef struct _ST_Z_REPORT_P16
{
	uint32 StructSize;
	uint16 Versiyon;
	uint32 Flag;
	...
	uint16 ZSeqNo;
	uint16 EkuNo;
	uint16 IncrementTotalCount;
	uint64 IncrementTotalAmount;
	uint16 DecrementTotalCount;
	uint64 DecrementTotalAmount;
	uint16 CorrectionTotalCount;
	uint64 CorrectionTotalAmount;
	uint16 FiscalReceiptCount; // Mali rapor ve ÖKC fiþleri ve Taxfree
	uint16 NonFiscalReceiptCount;
	uint16 CustomerReceiptCount;
	uint16 VoidSaleCount;
	uint64 VoidSaleTotalAmount;
	char   szEcrVersion[12 + 1];
	char   szUVKN[12 + 1];

	struct
	{
		ST_InfoTicketDetail  stInvoiceInfo;
		ST_InfoTicketDetail  stE_InvoiceInfo;
		ST_InfoTicketDetail  stE_ArchiveInvoiceInfo;
		ST_InfoTicketDetail  stFoodTicket;
		ST_InfoTicketDetail  stOtopark;
		ST_InfoTicketDetail  stMoneyCollection;
		ST_InfoTicketDetail  stCurrentAccount;
		ST_InfoTicketDetail  stTaxFree;
		ST_InfoTicketDetail  stCashAdvance;
		ST_InfoTicketDetail  stCashPayment;
		ST_InfoTicketDetail  stCustomerAdvance;
		ST_InfoTicketDetail  stSMM;
		ST_InfoTicketDetail  stExpenseTicket;
		ST_InfoTicketDetail  stETicket;
		ST_InfoTicketDetail  stEWaybill;
		ST_InfoTicketDetail  stOther;
	} stInfoTicketDetail;

	struct
	{
		ST_ECR_Document	stECRReceipt;
		ST_ECR_Document	stInvoice;
		ST_ECR_Document	stSMM;
		ST_ECR_Document	stExpenseTicket;
		ST_ECR_Document	stMM;
		ST_ECR_Document	stTicket;
		ST_ECR_Document	stVoid;
		ST_ECR_Document	stOther;
	} stECR_Document;

	struct
	{
		ST_PaymentInfo stCash;				// PAYMENT_CASH_TL, PAYMENT_CASH_CURRENCY
		ST_PaymentInfo stCredit;			//PAYMENT_BANK_CARD
		ST_PaymentInfo stVirtualPos;			// PAYMENT_SANAL_POS
		ST_PaymentInfo stTransferEft;			// PAYMENT_BANKA_TRANSFERI
		ST_PaymentInfo stE_MoneyFastMoney;	// PAYMENT_EPARA_HIZLI_PARA
		ST_PaymentInfo stCheckBillOpenAccount;	// PAYMENT_CEK, PAYMENT_GIDER_PUSULASI, PAYMENT_ACIK_HESAP, PAYMENT_KAPORA, PAYMENT_IKRAM, PAYMENT_ODEMESIZ,
		ST_PaymentInfo stGiftCard;		// PAYMENT_HEDIYE_CEKI
		ST_PaymentInfo stTransportCard;	//PAYMENT_ULASIM_KARTI
		ST_PaymentInfo stFoodCard;			//PAYMENT_YEMEKCEKI
		ST_PaymentInfo stMobile;				//PAYMENT_MOBILE,
		ST_PaymentInfo stPoint;				//PAYMENT_PUAN,
		ST_PaymentInfo stOther;				//PAYMENT_DIGER
		ST_PaymentInfo stTrQRFast;
		ST_PaymentInfo stTrQRCard;
		ST_PaymentInfo stTrQRMobile;
		ST_PaymentInfo stTrQROther;
	} stPaymentDetail;
	...
	struct
	{
		...
		uint16 Rate;
		uint64 TotalVat;
		uint64 TaxlessAmount;
	} stVatTable[8];

	uint64 TotalAmount;
	uint64 TotalVAT;
	uint64 CumulativeTotalAmount;
	uint64 CumulativeTotalVat;
	...
	{
		char  Name[12];
		uint64 TotalAmount; // Toplam Ödemeler
	} stCashier[4];

	uint64	TaxFreeRefundAmount;

	struct // ödeme kirilimi saðlayabilmek için parçalý ödemeye izin verilmemeli
	{
		uint16 Count;
		uint64 TotalAmount;
		struct
	...
	uint64			AccommondationTaxAmount;
	uint16 			AccommondationTaxRate;
} ST_Z_REPORT_P16;
...
GMP_EXTERN uint32 GMP_CALL_TYPE SetJavaClassPath(char *Path);

#define SetIniFilePath(szPath)			SetXmlFilePath(szPath)
#define GetIniFilePath(szPath)			GetXmlFilePath(szPath)

GMP_EXTERN void GMP_CALL_TYPE AppendAppLog(HINT hInt, char *szLine);

GMP_EXTERN uint32 GMP_CALL_TYPE GMP_CommonFunc(HINT hInt, int msgType, char* In_sendDataBuff, unsigned int dataLen, char* Out_receiveDataBuff, uint32 MaxOutBuffer, uint32* pOut_dataLen, int timeoutInMiliseconds);
...
GMP_EXTERN uint16	GMP_CALL_TYPE gmpTlvSetLenEx(uint8* pmsg, uint16 Max, uint16 TlvLen);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpSetTLV(uint8* pmsg, uint32 Tag, uint8* pdata, uint16 dataLen);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpSetTLVEx(uint8* pmsg, uint16 Max, uint32 Tag, uint8* pdata, uint16 dataLen);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpSetTLVbcd(uint8* pmsg, uint32 Tag, uint32 data, uint16 bcdLen);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpSetTLVbcdEx(uint8* pmsg, uint16 Max, uint32 Tag, uint32 data, uint16 bcdLen);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpSetTLVbcd_64(uint8* pmsg, uint32 Tag, uint64 data, uint16 bcdLen);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpSetTLVbcd_64Ex(uint8* pmsg, uint16 Max, uint32 Tag, uint64 data, uint16 bcdLen);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpReadTlv(uint8* Source, uint32* Tag, uint16* Len, uint8** Value);
GMP_EXTERN uint16	GMP_CALL_TYPE gmpReadTlvEx(uint8* Source, uint16 Bufsize, uint32* Tag, uint16* Len, uint8** Value);
...
GMP_EXTERN uint16	GMP_CALL_TYPE gmpSetTLV_HLEx(uint8* pmsg, uint32 pmsgLen, uint32 Max, uint32 Tag, uint8* pdata, uint16 dataLen);  //HighLevel
...
GMP_EXTERN uint32 GMP_CALL_TYPE GMP_GetDllVersionEx(char* szDllVersion, uint32 Max);
GMP_EXTERN uint32 GMP_CALL_TYPE GMP_StartPairingInit(ST_GMP_PAIR *pGMPPair, ST_GMP_PAIR_RESP *pGMPPairResp);
GMP_EXTERN uint32 GMP_CALL_TYPE ExchangeEcrMessage(int msgType, char *In_sendDataBuff, unsigned int dataLen, char * Out_receiveDataBuff, uint32 MaxOutBuffer, uint32 *pOut_dataLen, int timeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FiscalPrinter_KasaPayment(uint32 Amount, char* szJsonTicket_Out, int JsonTicketLen_Out, int TimeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FiscalPrinter_KasaAvans(uint32 Amount, char* szJsonTicket_Out, int JsonTicketLen_Out, int TimeoutInMiliseconds);
...
GMP_EXTERN int GMP_CALL_TYPE Json_prepare_SendSMMData(uint8* Buffer, int MaxSize, char* szJsonSMMData);
GMP_EXTERN int GMP_CALL_TYPE Json_prepare_SendSMMBilgiFisiData(uint8* Buffer, int MaxSize, char* szJsonSMMBilgiFisiData);
GMP_EXTERN int GMP_CALL_TYPE Json_prepare_SendGiderPusulasi(uint8* Buffer, int MaxSize, char* szJsonSMMData);
...
GMP_EXTERN int GMP_CALL_TYPE prepare_SendSMMBilgiFisiData(uint8* Buffer, int MaxSize, ST_SMM_BILGI_FISI_DATA* pstSMMBlgiFisiData);
GMP_EXTERN int GMP_CALL_TYPE prepare_SendGiderPusulasi(uint8* Buffer, int MaxSize, ST_GIDER_PUSULASI* pstGiderPusulasi);
GMP_EXTERN int GMP_CALL_TYPE prepare_SendEBilet(uint8* Buffer, int MaxSize, ST_E_BILET* pstEBilet);
GMP_EXTERN int GMP_CALL_TYPE prepare_SendEIrsaliyeInfo(uint8* Buffer, int MaxSize, ST_E_IRSALIYE_BILGI* pstEIrsaliyeInfo);
...
GMP_EXTERN int GMP_CALL_TYPE prepare_KasaAvans(uint8* Buffer, int MaxSize, uint32 amount, char* pCustomerName, char* pTckn, char* pVkn);
...
GMP_EXTERN int GMP_CALL_TYPE FP3_prepare_GetCurrentHandle(uint8* Buffer, int MaxSize);
...
GMP_EXTERN uint32 GMP_CALL_TYPE parse_GetEcr(ST_MULTIPLE_RETURN_CODE *returnCodes, uint16 MaxReturnCodes, uint16 *pnumberOfreturnCodes, uint32 recvmsgId, uint8 *recvFullBuffer, uint16 recvFullLen);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_FunctionNTP_Check(HINT hInt);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_FunctionPaperEject(HINT hInt);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_FunctionReadZReportP16(HINT hInt, ST_FUNCTION_PARAMETERS* pstFunctionParameters, ST_Z_REPORT_P16* pstZReport, int timeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_Get24HResetTime(HINT hInt, ST_PCI_24H_RESET_INFO* pstPCI24HResetInfo, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_Set24HResetTime(HINT hInt, ST_PCI_24H_RESET_INFO* pstPCI24HResetInfo, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_GetAllowedKDVInfo(HINT hInt, ST_ALLOWED_KDV_INFO* pstAllowedKdvInfo, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_GetNACEInfo(HINT hInt, ST_NACE_INFO* pstNaceInfo, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_GetLastTransInfo(HINT hInt, ST_LAST_TRANS_INFO* pstLastTransInfo, int timeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_GetDialogInput_MultipleCommand(HINT hInt, ST_MULTIPLE_RETURN_CODE *returnCodes, uint16 MaxReturnCodes, uint16 *pnumberOfreturnCodes, uint8 *sendBuffer, uint16 sendBufferLen, int timeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_FunctionReadZReportP16(HINT hInt, char* szJsonFunctionParameters, char* szJsonZReport_Out, int JsonZReportLen_Out, int TimeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_FunctionPaymentCheck(HINT hInt, char * uniqueId, char * szJsonCheckResponse_Out, int szJsonCheckResponseLen_Out, int TimeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_GetVasPaymentServiceInfo(HINT hInt, uint8 *pNumberOfTotalRecords, uint8 *pNumberOfTotalRecordsReceived, char* szJsonVASPaymentServiceInfo_Out, int JsonVASPaymentServiceInfoLen_Out, uint16 vasAppID);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_Get24HResetTime(HINT hInt, char* szJsonPCI24HResetInfo, char* szJsonPCI24HResetInfo_Out, int JsonPCI24HResetInfoLen_Out, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_Set24HResetTime(HINT hInt, char* szJsonPCI24HResetInfo, char* szJsonPCI24HResetInfo_Out, int JsonPCI24HResetInfoLen_Out, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_GetAllowedKDVInfo(HINT hInt, char* szJsonAllowedKdvInfo_Out, int JsonAllowedKdvInfoLen_Out, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_GetNACEInfo(HINT hInt, char* szJsonstNaceInfo_Out, int JsonstNaceInfoLen_Out, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_GetLastTransInfo(HINT hInt, char* szJsonstLastTransInfo_Out, int JsonstLastTransInfoLen_Out, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_LoyaltyProcess(HINT hInt, HTRX hTrx, char* szJsonLoyaltyProcess_In, char* szJsonLoyaltyProcess_Out, int JsonLoyaltyProcessLen_Out, char* szJsonTicket_In, int TimeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_Start(HINT hInt, HTRX* phTrx, uint8 IsBackground, uint8* uniqueId, int lengthOfUniqueId, uint8* uniqueIdSign, int lengthOfUniqueIdSign, uint8* userData, int lengthOfUserData, int timeoutInMiliseconds DEFAULT_PARAM_TIMEOUT_DEFAULT);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_StartEx(HINT hInt, HTRX* phTrx, uint8 IsBackground, uint8* uniqueId, int lengthOfUniqueId, uint8* uniqueIdSign, int lengthOfUniqueIdSign, uint8* userData, int lengthOfUserData, uint8* szHashExpireDate, int timeoutInMiliseconds DEFAULT_PARAM_TIMEOUT_DEFAULT);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_GetCurrentHandle(HINT hInt, HTRX* phTrx, uint8* uniqueId, int maxLengthOfUniqueId, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_Close(HINT hInt, HTRX hTrx, int timeoutInMiliseconds DEFAULT_PARAM_TIMEOUT_DEFAULT);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_CloseEx(HINT hInt, HTRX hTrx, ST_CLOSE* pstClose, int timeoutInMiliseconds DEFAULT_PARAM_TIMEOUT_DEFAULT);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_SendSMMBilgiFisiData(HINT hInt, HTRX hTrx, ST_SMM_BILGI_FISI_DATA* pstSMMBilgiFisiData, ST_TICKET* pstTicket, int timeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_SendEBilet(HINT hInt, HTRX hTrx, ST_E_BILET *pstEBilet, ST_TICKET* pstTicket, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_SendEIrsaliyeInfo(HINT hInt, HTRX hTrx, ST_E_IRSALIYE_BILGI *pstEIrsaliyeInfo, ST_TICKET* pstTicket, int timeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE FP3_CariHesap(HINT hInt, HTRX hTrx, uint32 Amount, ST_TICKET* pstTicket, char* pCustomerName, char* pTckn, char* pVkn, char* pBelgeNo, char* pBelgeDate, int timeoutInMiliseconds DEFAULT_PARAM_TIMEOUT_DEFAULT);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_Close(HINT hInt, HTRX hTrx, char *szJsonClose_Out, int szJsonCloseLen_Out, int timeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_Plus(HINT hInt, HTRX hTrx, uint32 Amount, char *szText, char *szJsonTicket_Out, int JsonTicketLen_Out, uint16 IndexOfItem , int TimeoutInMiliseconds);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_Minus(HINT hInt, HTRX hTrx, uint32 Amount, char *szText, char *szJsonTicket_Out, int JsonTicketLen_Out, uint16 IndexOfItem, int TimeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_KasaAvans(HINT hInt, HTRX hTrx, uint32 Amount, char* szJsonTicket_Out, int JsonTicketLen_Out, int TimeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_SendSMMBilgiFisiData(HINT hInt, HTRX hTrx, char* szJsonSMMBilgiFisiData, char* szJsonTicket_Out, int szJsonTicketLen_Out, int TimeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_KasaPayment(HINT hInt, HTRX hTrx, uint32 Amount, char* szJsonTicket_Out, int JsonTicketLen_Out, int TimeoutInMiliseconds);
...
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_CustomerAvans(HINT hInt, HTRX hTrx, uint32 Amount, char* szJsonTicket_Out, int szJsonTicketLen_Out, char* szCustomerName, char* szTckn, char* szVkn, int TimeoutInMiliseconds DEFAULT_PARAM_TIMEOUT_DEFAULT);
GMP_EXTERN uint32 GMP_CALL_TYPE Json_FP3_CariHesap(HINT hInt, HTRX hTrx, uint32 Amount, char* szJsonTicket_Out, int szJsonTicketLen_Out, char* szCustomerName, char* szTckn, char* szVkn, char* szBelgeNo, char* szBelgeDate, int TimeoutInMiliseconds DEFAULT_PARAM_TIMEOUT_DEFAULT);
...
#if defined(__TELIUM2__) || defined(__TELIUM3__)
typedef void (*TRACE_PRINT_INTERFACE)(uint8 Type, const char* Buffer);
typedef uint8(*TRACE_CHECK_TYPE)(uint8 Type);
typedef struct _ST_Gmp3Init
{
	TRACE_PRINT_INTERFACE TracePrintInterface;
	TRACE_CHECK_TYPE TraceCheckType;
} ST_Gmp3Init;
void InitGmp3Library(ST_Gmp3Init* pstGmp3Init);
uint32 GetTeliumInterfaceHandle(void);
#define DllTracePrintInterface				For using GMP3 Library firstly Call InitGmp3Library on AppGiveInterface function.
#define DllTraceCheckType					For using GMP3 Library firstly Call InitGmp3Library on AppGiveInterface function.
#define TELIUM_INTERFACE_HANDLE				For using GMP3 Library firstly Call InitGmp3Library on AppGiveInterface function. Call GetTeliumInterfaceHandle instead of TELIUM_INTERFACE_HANDLE.
#endif /*defined(__TELIUM2__) || defined(__TELIUM3__)*/
