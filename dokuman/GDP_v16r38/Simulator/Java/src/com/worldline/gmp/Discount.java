...
public class Discount extends JDialog {
	...
	private final JComboBox<GmpDriver.EDiscountType> cmbDiscType = new JComboBox<GmpDriver.EDiscountType>(GmpDriver.EDiscountType.values());
	...
	public Discount(GmpDriver gmpDriverObj) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
					...
					gmpDriver.RaiseAndDiscount(MainFrame.getCurrentInt(), MainFrame.getCurrentTrx(), Short.valueOf(txtIndexOfItem.getText()), cmbDiscType.getSelectedIndex(), txtDiscValue.getText()); 
