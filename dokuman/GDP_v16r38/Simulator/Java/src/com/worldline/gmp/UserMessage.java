	...
	public UserMessage(GmpDriver gmpDriverObj) {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            ...
	            {
	            	JOptionPane.showMessageDialog(null,"Mesaj Alani 48 karakterden fazla olamaz");
		            return;
	            }
		...
		btnPrint.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	            ...
	            for (int i = 0; i < numberOfUserMessages; i++)
	            {
	            	...
	            	stUserMessage[i].message  = GmpDriver.getNulTerminatedBytes(data[1]);
	            }
  
	            int retcode = Defines.TRAN_RESULT_OK;

	            retcode = gmpDriver.FP3_PrintUserMessage(MainFrame.getCurrentInt(), MainFrame.getCurrentTrx(), stUserMessage, (short)numberOfUserMessages, gmpDriver.gstTicket, gmpDriver.TIMEOUT_DEFAULT);
		...
		lstLines = new JList<String>(listModel);
