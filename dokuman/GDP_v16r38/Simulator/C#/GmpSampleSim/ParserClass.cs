...
namespace GmpSampleSim
{
    class ParserClass
    {
        ...
        public static void DisplayEcrStatus(ST_GMP_PAIR_RESP stPairResp, ST_ECHO echoStr)
        {
            ...
            DisplayStructInTree("ECR Version Num", stPairResp.szNewVersionNumber);
            ...
            DisplayStructInTree("ECR Version", echoStr.szEcrNewVersion);
            DisplayStructInTree("ECR Ekü No", echoStr.EkuNo.ToString());
            DisplayStructInTree("ECR Z No", echoStr.ZNo.ToString());
            DisplayStructInTree("ECR Fiş No", echoStr.FisNo.ToString());
            DisplayStructInTree("ECR Current Handle", echoStr.Handle.ToString());
            DisplayStructInTree("ECR Current UniqueID", echoStr.UniqueID == null ? "NULL" : GMP_Tools.GetHexStringFromBytes(echoStr.UniqueID));
