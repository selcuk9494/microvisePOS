    ...
    public partial class TestDialog : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < echoCount; i++)
            {
                ...
                UInt32 retcode = Json_GMPSmartDLL.FP3_Echo(GMPForm.CurrentInterface, ref stEcho, Defines.TIMEOUT_ECHO);
                GMPForm.SetFunctionCallLog("FP3_Echo", retcode, start);
                duration1 = DateTime.Now - start1;
        ...
        private void btnOtoInit_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Convert.ToInt32(textBox5.Text) - 1; i++)
            {
                ...
                GMPForm.SetFunctionCallLog("FP3_StartPairingInit", resp, start);

                ErrorClass.DisplayErrorMessage("FP3_StartPairingInit", resp);
        ...
        private void m_btnCreateInterface_Click(object sender, EventArgs e)
        {
            ...
            stXmlInterfaceData.IsTcpKeepAlive = 0;
            ...
            TestForm.HandleErrorCode("FP3_CreateInterface", RetCode);
        }
        ...
        private void m_btnGetTlvData_Click(object sender, EventArgs e)
        {
            ...
            ErrorClass.DisplayErrorMessage("FP3_GetTlvData", RetCode);
        }
        ...
        private void m_btnGetTaxRates_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_GetTaxRates", RetCode, start);
            ...
            ErrorClass.DisplayErrorMessage("FP3_GetTaxRates", RetCode);
        }
        ...
        private void m_btnGetDepartment_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_GetDepartments", RetCode, start);
        ...
        private void m_btnGetGlobalXmlData_Click(object sender, EventArgs e)
        {
            ...
            int start = Environment.TickCount;
            UInt32 RetCode = Json_GMPSmartDLL.FP3_GetGlobalXmlData(ref stGlobalXmlData);
            GMPForm.SetFunctionCallLog("FP3_GetGlobalXmlData", RetCode, start);
        ...
        private void m_btnSetGlobalXmlData_Click(object sender, EventArgs e)
        {
            ...
            int start = Environment.TickCount;
            UInt32 RetCode = Json_GMPSmartDLL.FP3_UpdateGlobalXmlData(ref stGlobalXmlData);
            GMPForm.SetFunctionCallLog("FP3_UpdateGlobalXmlData", RetCode, start);
        ...
        public void m_btnSetXmlFilePath_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("SetXmlFilePath", RetCode, start);

            TestForm.HandleErrorCode("SetXmlFilePath", RetCode);
        }
        ...
        private void m_btnRemoveInterface_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_RemoveInterfaceByID", RetCode, start);

            TestForm.HandleErrorCode("FP3_RemoveInterfaceByID", RetCode);
        }
        ...
        private void m_btnGetInterfaceXmlData_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_GetInterfaceXmlDataByID", RetCode, start);

            TestForm.HandleErrorCode("FP3_GetInterfaceXmlDataByID", RetCode);
            ...
            if (RetCode == 0)
            {
                string str = "Interface ID : " + InterfaceId + Environment.NewLine +
                                ...
                                "IsTcpKeepAlive : " + stInterfaceXmlData.IsTcpKeepAlive.ToString() + Environment.NewLine +
        ...
        private void m_btnTestUserMessage_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_PrintUserMessage_Ex", retcode, start);
            ...
            GMPForm.SetFunctionCallLog("FP3_PrintUserMessage", retcode, start);
