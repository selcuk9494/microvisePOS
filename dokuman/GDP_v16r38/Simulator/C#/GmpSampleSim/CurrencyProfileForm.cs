...
namespace GmpSampleSim
{
    public partial class CurrencyProfileForm : Form
    {
        ...
        public void SetCurrencyProfiles()
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_GetCurrencyProfile", retcode, start);
            if (retcode != 0)
            {
                ErrorClass.DisplayErrorMessage("FP3_GetCurrencyProfile", retcode);
                return;
            }
            ...
            if (comboBoxCurrencyProfile.Items.Count > 0)
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_SetCurrencyProfile", retcode, start);

            /* if save is successfull, reset the newItem.*/
            if (retcode == 0) newItem = -1;
            ErrorClass.DisplayErrorMessage("FP3_SetCurrencyProfile", retcode);
        }
