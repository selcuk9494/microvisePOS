    ...
    public partial class UserDataForm : Form
    {
        ...
        private void buttonSend_Click(object sender, EventArgs e)
        {
            ...
            }else
            {
                ...
                GMPForm.SetFunctionCallLog("FP3_SendUserData", RetCode, start);
                parent.HandleErrorCode("FP3_SendUserData", RetCode);
            }
        }
        ...
        private void buttonAl_Click(object sender, EventArgs e)
        {
            ...
            GMPForm.SetFunctionCallLog("FP3_GetUserData", RetCode, start);
            parent.HandleErrorCode("FP3_GetUserData", RetCode);
